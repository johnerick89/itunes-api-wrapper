        ...
        if album is None:
            try:
                album_serializer = AlbumSerializer(data={
                    ...
                    'collection_price': album_data.get('collectionPrice'),
                    'currency': album_data.get('currency'),
                    'artwork_url': album_data.get('artworkUrl100'),
                    'collection_view_url': album_data.get('collectionViewUrl')
                })
        ...
        if song is None:
            try:
                song_serializer = SongSerializer(data={
                                                    ...
                                                    'track_price': song_data.get('trackPrice'),
                                                    'currency': song_data.get('currency'),
                                                    'track_view_url': song_data.get('trackViewUrl'),
                                                    'preview_url': song_data.get('previewUrl')
                                                })
